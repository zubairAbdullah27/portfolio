...
export const ProjectCard: FC<Props> = ({ project, setSelectedProject }) => {
    return (
        <div
            ...
            className="flex flex-col md:flex-row items-start gap-6 p-6 rounded-xl hover:bg-gradient-to-br from-[#0f172a] to-[#1e293b] transition-transform hover:scale-[1.01] cursor-pointer"
        >
            {/* Thumbnail + Timeline */}
